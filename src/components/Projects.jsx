...
const projects = [
  {
    ...
    solution: '搭建「真人播报流」与「卡通形象流」双轨工作流。真人流运用 ReActor 换脸 + Context 融合技术，攻克换装后边缘溢色与背景光照不协调难题，实现电影级逼真口播与场景替换；卡通流支持教授卡通形象快速出境，产出趣味动漫风格微课视频。',
    result: [
  ...
  },
  {
    ...
    solution: '基于 ComfyUI 搭建一键生成工作流，实现用户端仅需点选字体分格与文字位置，后台通过提示词针对性扩充，生成极具特色的专属艺术字体和相关元素课程海报，大幅提升封面转化率。',
    result: [
  ...
  },
  {
    ...
    solution: '数字化并清洗 200+ 份《建筑四书》历史图纸，按构件、立面分类标注构建标准数据集；基于 SDXL 训练扩散模型，通过调整词汇标注频率及 ControlNet 精准控制，成功融合出全新风格立面。',
    result: [
